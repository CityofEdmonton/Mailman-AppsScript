...
define(
  ...
  function () {
    ...
    var getWindowUrl = function (editor) {
      return editor.getParam('plugin_window_url', 'https://cityofedmonton.github.io/Mailman-AppsScript/lib/tinymce/tinymce/popup.html');
    };
  ...
  function (window, Env, Tools, Settings) {
    var open = function (editor) {
      ...
      window.addEventListener("message", function (e) {
        if (e.origin !== "https://cityofedmonton.github.io") {
          return;
        }
        var eventSource = e.source;
        if (e.data.message === "Loaded") {
          eventSource.postMessage({ message: "Content", content: editor.getContent() }, "https://cityofedmonton.github.io");
          ...
          if (updatedContent && typeof (updatedContent.then) === 'function') {
            updatedContent.then(function (previewText) {
              ...
              eventSource.postMessage({ message: "PreviewResponse", state: previewState }, "https://cityofedmonton.github.io");
            }, function (previewError) {
              eventSource.postMessage({ message: "PreviewResponse", error: previewError }, "https://cityofedmonton.github.io");
            });
          } else {
            eventSource.postMessage({ message: "PreviewResponse", state: previewState }, "https://cityofedmonton.github.io");
          }
          ...
          if (updatedSuggestions && typeof (updatedSuggestions.then) === 'function') {
            updatedSuggestions.then(function (updateSuggestionsContent) {
              ...
              eventSource.postMessage({ message: "SuggestionsResponse", state: suggestionsState }, "https://cityofedmonton.github.io");
            }, function (suggestionsError) {
              eventSource.postMessage({ message: "SuggestionsResponse", error: suggestionsError }, "https://cityofedmonton.github.io");
            });
          } else {
            eventSource.postMessage({ message: "SuggestionsResponse", state: suggestionsState }, "https://cityofedmonton.github.io");
          }
  ...
  function () {
    var register = function (editor) {
      editor.addButton('window', {
        title: 'Window',
        cmd: 'mceWindow',
        image: 'https://cityofedmonton.github.io/Mailman-AppsScript/lib/tinymce/tinymce/icons/window.png'
      });
