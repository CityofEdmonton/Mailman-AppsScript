...
/*jsc
["tinymce.plugins.preview.Plugin","tinymce.core.PluginManager","tinymce.plugins.preview.api.Commands","tinymce.plugins.preview.ui.Buttons","global!tinymce.util.Tools.resolve","tinymce.plugins.preview.ui.Dialog","tinymce.core.Env","tinymce.core.util.Tools","tinymce.plugins.preview.api.Settings","tinymce.plugins.preview.ui.IframeContent","tinymce.plugins.preview.api.Events","tinymce.core.util.Promise"]
jsc*/
...
define(
  ...
  function () {
    var firePreviewing = function (editor, state) {
      editor.fire('Previewing', { state: state });
    };

    return {
      firePreviewing: firePreviewing
    };
  }
);
/**
...
define(
  ...
  function (Tools, Settings, Events, Promise) {
    var getPreviewHtml = function (editor) {
      ...
      // fire previewing event
      var args = { content: editor.getContent() };
      Events.firePreviewing(editor, args);
      var content = args.content;

      var isContentAPromise = typeof ((content || {}).then) === "function";
      if (isContentAPromise) {
    ...
    var injectIframeContent = function (editor, iframe, sandbox) {
      ...
      if (isPromise) {
        previewHtml.then(function (text) {
